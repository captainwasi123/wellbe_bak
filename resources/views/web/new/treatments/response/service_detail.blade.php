<div class="block-element card-form-head m-b-3">
   ...
   <p> From {{empty($data->lowestPrice) || $data->lowestPrice->price > $data->price ? '$'.number_format($data->price, 2) : '$'.number_format($data->lowestPrice->price, 2)}}  - Duration {{$data->duration}} Minutes </p>
</div>
