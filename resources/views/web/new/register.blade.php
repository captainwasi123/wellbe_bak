               ...
               <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 no-pad">
                  <div class="login-wrapper">
                           ...
                           <div class="row">
                              <div class="col-md-6 col-lg-6 col-sm-6 col-12">
                                 <div class="block-element m-b-20">
                                    ...
                                    <input type="text" placeholder="First Name" name="" class="form-control1">
                                 </div>
                              </div>
                              <div class="col-md-6 col-lg-6 col-sm-6 col-12">
                                 <div class="block-element m-b-20">
                                    <p class="col-black form-label1"> Last Name  </p>
                                    <input type="text" placeholder="Last Name" name="" class="form-control1">
                                 </div>
                              </div>
                           </div>
                           <div class="block-element m-b-20">
                              <p class="col-black form-label1"> Email Address  </p>
                              <input type="email" placeholder="Email Address" name="" class="form-control1">
                           </div>
                           <div class="block-element m-b-20">
                              <p class="col-black form-label1"> Phone Number  </p>
                              <div class="input-group" style="display: block;">
                                 <input type="number" class="form-control1 input-num">
                              </div>
                           </div>
                           <div class="block-element m-b-20">
                              <p class="col-black form-label1"> Password  </p>
                              <input type="password" placeholder="Your Password" name="" class="form-control1">
                           </div>
                           <div class="block-element m-b-20">
                              <div class="checkbox-field1"> <input type="checkbox" name=""> By signing up I agree  to Wellbe Terms & Conditons and Privacy Policy </div>
                           </div>
                     ...
                     <div class="already-account m-t-40">
                        <span class="col-black"> Already an user? <a href=""> Login </a> </span>
                     </div>
