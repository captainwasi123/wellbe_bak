...
<td valign="top" style="padding:10px;"><div style="font-family:Cabin, sans-serif;font-size:40px;color:#0e4464;line-height:40px;letter-spacing: 0.03em;text-align:left;"><p style="padding: 0; margin: 0;"><span class="mso-font-fix-arial"><strong><span style="font-size: 24px;">Query From Wellbe.co.nz</span></strong></span></p>
</div>
</td>
</tr>
</table>
...
<td valign="top" style="padding:10px;"><div style="font-family:Cabin, sans-serif;font-size:18px;color:#0e4464;line-height:20px;letter-spacing: 0.03em;text-align:left;"><p style="padding: 0; margin: 0;"><span class="mso-font-fix-arial">Hi Concern,</span></p>

<p style="padding: 0; margin: 0;">&nbsp;</p>

<p style="padding: 0; margin: 0;"><span class="mso-font-fix-arial">You got a new query from contact us page of wellbe.co.nz</span></p>

<p style="padding: 0; margin: 0;">&nbsp;</p>
<p style="padding: 0; margin: 0;"><span class="mso-font-fix-arial">Name: <br><strong>{{$name}}</strong></span></p>
<br>
<p style="padding: 0; margin: 0;"><span class="mso-font-fix-arial">Email: <br><strong>{{$email}}</strong></span></p>
<br>
<p style="padding: 0; margin: 0;"><span class="mso-font-fix-arial">Query: <br><strong>{{$messages}}</strong></span></p>
</div>
</td>
</tr>
</table>
