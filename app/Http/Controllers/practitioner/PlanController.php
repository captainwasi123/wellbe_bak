...
class PlanController extends Controller
{
  ...
  public function plan_buy($id){
 	  ...
 	  $subcrption->is_active = 0;
 	  $subcrption->save();

    return view('web.payments.plan.stripe', ['id' => $subcrption->id, 'amount' => $plan_data->price]);
  }

  public function plan_confirm($id){
    $p = PackageUserSubscription::find($id);
    $p->is_active = 1;
    $p->save();
